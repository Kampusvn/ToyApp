...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // Hoàn thành (5) Lưu địa chỉ vào một String
        String addressString = "1600 Amphitheatre Parkway, CA";

        // Hoàn thành (6) Sử dụng Uri.Builder với lược đồ và truy vấn thích hợp để tạo thành Uri cho địa chỉ
        ...
        // Hoàn thành (7) Thay thế Toast bằng lời gọi showMap và chuyền Uri từ bước trước vào
        showMap(addressUri);
    }
    ...
    // Hoàn thành (1) Viết phương thức showMap với Uri là tham số
    /**
    ...
    private void showMap(Uri geoLocation) {
        // Hoàn thành (2) Create an Intent with action type, Intent.ACTION_VIEW
        /*
         * Ta tạo Intent với ACTION_VIEW vì ta muốn xem (VIEW) nội dung của Uri
         */
        Intent intent = new Intent(Intent.ACTION_VIEW);

        // Hoàn thành (3) Set the data of the Intent to the Uri passed into this method
        /*
