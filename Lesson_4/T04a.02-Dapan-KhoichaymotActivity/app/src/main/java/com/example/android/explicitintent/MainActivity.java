    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Hoàn thành (1) Lưu trữ ChildActivity.class trong lớp destinationActivity
                /* Đây là lớp ta mở (và khởi chạy) khi nút được bấm. */
                Class destinationActivity = ChildActivity.class;

                // Hoàn thành (2) Tạo Intent để khởi chạy ChildActivity
                /*
                ...
                // Hoàn thành (3) Thay thế Toast bằng code chạy ChildActivity
                /*
