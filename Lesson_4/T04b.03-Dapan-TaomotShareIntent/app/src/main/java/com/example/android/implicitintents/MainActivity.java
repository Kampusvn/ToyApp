...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // Hoàn thành (5) Chỉ định một String bạn muốn chia sẻ
        /* Tạo String muốn chia sẻ */
        String textThatYouWantToShare =
                "Sharing the thing I've learned. You should " +
                        "check out Kampus.vn to know about this!";

        // Hoàn thành (6) Thay thế Toast bằng shareText và chuyền vào String lấy từ bước 5
        /* Đưa text vào phương thức share. */
    ...
    // Hoàn thành (1) Viết phương thức Void tên là shareText chấp nhận tham số kiểu String
    /**
     * Phương thức này chia sẻ văn bản và cho phép người dùng chọn ứng dụng để chia sẻ. Sử dụng
     * IntentBuilder của ShareCompat, ta có thể dùng được một số tính năng miễn phí. Pop up lựa
     * chọn được khởi chạy bằng cách sử dụng phương thức {@link IntentBuilder # startChooser ()}
     * để tạo trình chọn lựa khi nhiều ứng dụng trên thiết bị có thể xử lý Intent. Việc này xảy
     * ra khi người dùng có cả ứng dụng văn bản và ứng dụng email. Nếu chỉ có một Activity trên
     * thiết bị có thể xử lý Intent, nó sẽ tự động được khởi chạy.
     *
     * @param textToShare Text để chia sẻ
     */
    private void shareText(String textToShare) {
        // Hoàn thành (2) Tạo biến String tên là mimeType và đặt vào "text/plain"
        /*
         * Bạn có thể coi các kiểu MIME tương tự như các phần mở rộng của tập tin. Việc đó không thực sự
		 * chính xác, nhưng các kiểu MIME giúp máy tính xác định ứng dụng nào có thể mở nội dung nào.
		 * Ví dụ: nếu bạn nhấp đúp vào tệp .pdf, bạn sẽ thấy một danh sách các chương trình có thể mở
		 * tệp PDF. Chỉ định kiểu MIME là text/plain có ảnh hưởng tương tự đối với implicit Intent ở đây.
		 * Với text/plain, tất cả các ứng dụng có thể xử lý nội dung văn bản sẽ được liệt kê khi gọi
		 * startActivity với Intent này.
         */
        String mimeType = "text/plain";

        // Hoàn thành (3) Tạo tiêu đề cho pop up chọn lựa bật lên
        /* Đây là tiêu đề của cửa sổ sẽ xuất hiện khi chúng ta gọi startActivity */
        String title = "Share";

        // Hoàn thành (4) Sử dụng ShareCompat.IntentBuilder để xây dựng Intent và khởi chạy pop up chọn lựa
        /* ShareCompat.IntentBuilder cung cấp một API cho việc tạo ra Intent */
        ShareCompat.IntentBuilder
                /* Phương thức from xác định Context chứa nội dung chia sẻ*/
                .from(this)
                .setType(mimeType)
