...
public class TaskContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        // Truy cập vào database và viết code cho URI matching để nhận diện một item đơn lẻ
        final SQLiteDatabase db = mTaskDbHelper.getWritableDatabase();
        ...
        // Viết code để xóa một hàng dữ liệu
        ...
        // Thông báo thay đổi cho resolver và trả lại số lượng item đã bị xóa
        if (tasksDeleted != 0) {
