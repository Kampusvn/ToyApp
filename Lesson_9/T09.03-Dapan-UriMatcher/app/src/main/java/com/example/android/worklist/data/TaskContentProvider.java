...
public class TaskContentProvider extends ContentProvider {
    ...
    // Hoàn thành (1) Xác định hằng số nguyên cuối cùng cho thư mục các task và một item đơn lẻ.
    ...
    // Hoàn thành (3) Khai báo một biến static cho hàm matcher Uri mà bạn xây dựng
    private static final UriMatcher sUriMatcher = buildUriMatcher();

    // Hoàn thành (2) Xác định một phương thức static buildUriMatcher kết hợp URI với đối tượng int của chúng
    /**
