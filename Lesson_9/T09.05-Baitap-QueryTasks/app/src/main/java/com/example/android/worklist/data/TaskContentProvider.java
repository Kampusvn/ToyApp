...
public class TaskContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        // TODO (1) Truy cập vào cơ sở dữ liệu cơ bản (chế độ chỉ đọc cho truy vấn)

        // TODO (2) Viết code match URI và đặt biến để trả về một con trỏ

        // TODO (3) Truy vấn thư mục task và viết cho trường hợp mặc định

        // TODO (4) Đặt URI thông báo trên con trỏ và trả về con trỏ đó
