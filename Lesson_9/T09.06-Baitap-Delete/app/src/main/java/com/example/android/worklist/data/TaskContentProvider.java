...
public class TaskContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        // TODO (1) Truy cập vào database và viết code cho URI matching để nhận diện một item đơn lẻ

        // TODO (2) Viết code để xóa một hàng dữ liệu
        // [Gợi ý] dùng selection để xóa item dựa vào ID của hàng

        // TODO (3) Thông báo thay đổi cho resolver và trả lại số lượng item đã bị xóa
