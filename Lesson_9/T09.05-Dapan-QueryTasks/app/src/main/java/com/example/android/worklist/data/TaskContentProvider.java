...
public class TaskContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        // Hoàn thành (1) Truy cập vào cơ sở dữ liệu cơ bản (chế độ chỉ đọc cho truy vấn)
        final SQLiteDatabase db = mTaskDbHelper.getReadableDatabase();

        // Hoàn thành (2) Viết code match URI và đặt biến để trả về một con trỏ
        int match = sUriMatcher.match(uri);
        Cursor retCursor;

        // Hoàn thành (3) Truy vấn thư mục task và viết cho trường hợp mặc định
        switch (match) {
        ...
        // Hoàn thành (4) Đặt URI thông báo trên con trỏ và trả về con trỏ đó
