...
public class MainActivity extends AppCompatActivity {
    ...
    // Hoàn thành (1) Tạo một static final key để lưu trữ URL truy vấn
    /* Hằng số lưu trữ và khôi phục URL hiển thị */
    private static final String SEARCH_QUERY_URL_EXTRA = "query";

    // Hoàn thành (2) Tạo một static final key để lưu trữ JSON nguyên bản của tìm kiếm
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hoàn thành (9) Nếu savedInstanceState bundle không phải null, thiết lập văn bản của URL và kết quả tìm kiếm TextView tương ứng
    ...
    // Hoàn thành (3) Ghi đè lên SaveInstanceState để duy trì dữ liệu trên Activity
    @Override
    protected void onSaveInstanceState(Bundle outState) {
        // Hoàn thành (4) Chắc chắn rằng super.onSaveInstanceState được gọi trước khi làm các việc khác
        super.onSaveInstanceState(outState);

        // Hoàn thành (5) Đặt nội dung của TextView chứa URL vào một biến
        String queryUrl = mUrlDisplayTextView.getText().toString();

        // Hoàn thành (6) Sử dụng key cho URL truy vấn, đặt chuỗi trong Bundle bên ngoài
        outState.putString(SEARCH_QUERY_URL_EXTRA, queryUrl);

        // Hoàn thành (7) Đặt nội dung của TextView có chứa các kết quả tìm kiếm JSON thô vào một biến
        String rawJsonSearchResults = mSearchResultsTextView.getText().toString();

        // Hoàn thành (8) Sử dụng key cho kết quả tìm kiếm JSON thô, đưa kết quả tìm kiếm vào Bundle bên ngoài
