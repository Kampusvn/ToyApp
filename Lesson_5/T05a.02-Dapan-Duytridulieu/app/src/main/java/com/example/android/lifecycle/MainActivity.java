...
public class MainActivity extends AppCompatActivity {
    ...
    // Hoàn thành (1) Tạo một String key tên là LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hoàn thành (6) Nếu savedInstanceState không phải null và có chứa LIFECYCLE_CALLBACKS_TEXT_KEY, đặt set that text on our TextView
    ...
    // Hoàn thành (2) Override onSaveInstanceState
    @Override
    protected void onSaveInstanceState(Bundle outState) {
        // Hoàn thành (3) Gọi super.onSaveInstanceState
        super.onSaveInstanceState(outState);
        // Hoàn thành (4) Gọi logAndAppend với chuỗi ON_SAVE_INSTANCE_STATE
        logAndAppend(ON_SAVE_INSTANCE_STATE);
        // Hoàn thành (5) Đặt text từ TextView trong outState bundle
