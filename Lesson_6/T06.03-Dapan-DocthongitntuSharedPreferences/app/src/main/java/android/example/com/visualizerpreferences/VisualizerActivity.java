...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // Hoàn thành (1) Đổi tên defaultSetup thành setupSharedPreferences
    private void setupSharedPreferences() {
        // Nhận tất cả các giá trị từ shared preferences để thiết lập
        // Hoàn thành (2) Lấy tham chiếu preferences mặc định được chia sẻ từ class PreferenceManager
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        // Hoàn thành (3) Lấy giá trị của tùy chọn show_bass và sử dụng nó để gọi setShowBass
