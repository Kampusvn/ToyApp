...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TODO (4) Cập nhật code ở setupSharedPreferences và onSharedPreferenceChanged để cập
    // nhật mVisualizerView hiển thị các giá trị hiện tại được lưu trữ trong shared preference.
