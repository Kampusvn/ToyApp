...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        // Hoàn thành (3) Register (đăng ký) listener
        // Register listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    // Hoàn thành (2) Override phương thức onSharedPreferenceChanged và cập nhật show bass preference
    // Cập nhật lên màn hình nếu shared preferences thay đổi. Phương thức này là cần thiết khi bạn
    // tạo một lớp có implement OnSharedPreferenceChangedListener
    @Override
    ...
    // Hoàn thành (4) Override onDestroy và unregister the listener
    @Override
