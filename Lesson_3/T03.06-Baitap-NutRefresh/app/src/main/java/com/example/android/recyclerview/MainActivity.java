...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (2) Tạo menu resource ở res/menu/ called main.xml
    // TODO (3) Thêm item vào menu với ID là action_refresh
    // TODO (4) Đặt tiêu đề là "Refresh" bằng strings.xml
    // TODO (5) Đặt giá trị orderInCategory là 1 để đảm bảo item này ở vị trí đầu tiên trong danh sách
    // TODO (6) Thiết lập app:showAsAction thành ifRoom để hiển thị menu item trong ActionBar nếu có chỗ trống


    // TODO (7) Override onCreateOptionsMenu
    // TODO (8) Sử dụng getMenuInflater().inflate để inflate menu
    // TODO (9) Trả về true để hiển thị menu

    // TODO (10) Override onOptionsItemSelected
    // TODO (11) Trong phương thức này, lấy ID từ MenuItem
    // TODO (12) Nếu ID bằng R.id.action_refresh, tạo mới và thiết lập adapter trong RecyclerView và trả về true
    // TODO (13) Với các ID khác, trả về super.onOptionsItemSelected
}