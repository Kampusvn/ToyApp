...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // Hoàn thành (3) Khai báo biến final private ListItemClickListener là mOnClickListener
    /*
     * Trình quản lí thao tác bấm giúp Activity giao tiếp với RecyclerView dễ dàng hơn
     */
    ...
    // Hoàn thành (1) Thêm một interface là ListItemClickListener
    // Hoàn thành (2) Trong interface này, định nghĩa phương thức onListItemClick kiểu void, và nhận tham số int
    /**
     * Interface nhận message từ onClick.
     */
    public interface ListItemClickListener {
        void onListItemClick(int clickedItemIndex);
    }

    // Hoàn thành (4) Thêm ListItemClickListener là tham số trong constructor và lưu trữ trong mOnClickListener
    /**
    ...
    // Hoàn thành (5) Implement OnClickListener trong lớp NumberViewHolder
    /**
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder
        ...
        // Cho biết ViewHolder nào đang hiển thị dữ liệu
        ...
        public NumberViewHolder(View itemView) {
            ...
            // Hoàn thành (7) Gọi phương thức setOnClickListener trong View chuyền vào hàm constructor (sử dụng 'this' cho OnClickListener)
        ...
        // Hoàn thành (6) Override phương thức onClick, chuyển vị trí item được bấm (getAdapterPosition ()) sang mOnClickListener thông qua phương thức onListItemClick
        /**
         * Được gọi khi người dùng bấm vào một item trong danh sách.
