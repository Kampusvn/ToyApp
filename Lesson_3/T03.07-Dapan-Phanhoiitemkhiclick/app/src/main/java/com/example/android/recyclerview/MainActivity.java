...
// Hoàn thành (8) Implement GreenAdapter.ListItemClickListener từ MainActivity
public class MainActivity extends AppCompatActivity
    ...
    // Hoàn thành (9) Tạo biến kiểu Toast đặt tên là mToast để lưu trữ Toast pop up hiện tại
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hoàn thành (13) Chuyền 'this' (thay thế cho ListItemClickListener) vào constructor của GreenAdapter
        /*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.action_refresh:
                // Hoàn thành (14) Chuyền 'this' (thay thế cho ListItemClickListener) vào constructor của GreenAdapter
                mAdapter = new GreenAdapter(NUM_LIST_ITEMS, this);
                mNumbersList.setAdapter(mAdapter);
                return true;
        }
    ...
    // Hoàn thành (10) Override phương thức onListItemClick của ListItemClickListener
    @Override
    public void onListItemClick(int clickedItemIndex) {
        // Hoàn thành (11) Ở đầu phương thức, hủy Toast nếu nó không phải là null
        if (mToast != null) {
            mToast.cancel();
        }

        // Hoàn thành (12) Hiển thị Toast và chỉ số của item khi bấm vào
