...
/**
 * ColorUtils là một lớp với một phương thức, được sử dụng để tô màu ViewHolders trong RecyclerView.
 * Tôi đặt code trong các lớp riêng để có thể tổ chức và kiểm soát tốt hơn.
 * Chúng ta sẽ không đi sâu vào chi tiết về cách hoạt động của phương thức này, nhưng bạn có thể
 * thử khám phá.
 */
public class ColorUtils {

    /**
     * Phương thức tạo ra màu nền xanh lục
     */
