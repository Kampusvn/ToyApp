...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (6) Gọi phương thức addAction trên intent filter và thêm Intent.ACTION_POWER_CONNECTED
        // với Intent.ACTION_POWER_DISCONNECTED. Việc này sẽ thiết lập một intent filter để kích hoạt
        // khi trạng thái sạc thay đổi.
    }

    // TODO (7) Override onResume và thiết lập broadcast receiver. Thực hiện việc này bằng cách gọi
    // registerReceiver với ChargingBroadcastReceiver và IntentFilter.

    // TODO (8) Override onPause và hủy đăng ký receiver bằng phương thức unregisterReceiver
    ...
    // TODO (1) Viết phương thức showCharging nhận vào một boolean. Phương thức này thay đổi hình ảnh của
    ...
    // TODO (2) Tạo inner class ChargingBroadcastReceiver extends từ BroadcastReceiver
    // TODO (3) Override onReceive để có action từ intent và xem nó có match với
    // Intent.ACTION_POWER_CONNECTED hay không. Nếu match thì thiết bị đang được sạc.
    // Nếu không thì thiết bị đang không sạc.
    // TODO (4) Cập nhật UI bằng phương thức showCharging
}