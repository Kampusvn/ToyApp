...
public class GuestListAdapter extends RecyclerView.Adapter<GuestListAdapter.GuestViewHolder> {
    ...
    // Hoàn thành (8) Thêm biến local là mCount để lưu trữ số lượng item hiển thị trên recycler view
    private int mCount;

    // Hoàn thành (9) Update Adapter constructor để nó nhận một tham số nguyên
    /**
    ...
    public GuestListAdapter(Context context, int count) {
        ...
        // Hoàn thành (10) Đặt mCount = count
        mCount = count;
    }
    ...
    // Hoàn thành (11) Sửa getItemCount để nó trả về giá trị của mCount thay vì 0
    @Override
