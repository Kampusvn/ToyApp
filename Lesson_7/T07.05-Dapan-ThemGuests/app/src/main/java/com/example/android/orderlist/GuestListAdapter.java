...
public class GuestListAdapter extends RecyclerView.Adapter<GuestListAdapter.GuestViewHolder> {
    ...
    // Hoàn thành (15) Tạo hàm swapCursor lấy cursor mới và trả về void
    /**
    ...
    public void swapCursor(Cursor newCursor) {
        // Hoàn thành (16) Bên trong, kiểm tra cursor nếu không bằng null, và kết thúc nếu đúng
        // Luôn đóng mCursor cũ trước
        if (mCursor != null) mCursor.close();
        // Hoàn thành (17) Cập nhật mCursor bằng newCursor
        mCursor = newCursor;
        // Hoàn thành (18) Bên trong, kiểm tra newCursor nếu không bằng null, nếu đúng thì gọi this.notifyDataSetChanged()
        if (newCursor != null) {
