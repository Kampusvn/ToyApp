...
public class DatabaseTest {
    ...
    /* Context used to perform operations on the database and create OrderlistDbHelper */
    private final Context mContext = InstrumentationRegistry.getTargetContext();
    /* Class reference to help load the constructor on runtime */
    private final Class mDbHelperClass = OrderlistDbHelper.class;
    ...
    public void create_database_test() throws Exception{
        ...
        /* Use OrderlistDbHelper to get access to a writable database */
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                OrderlistContract.OrderlistEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(OrderlistContract.OrderlistEntry.COLUMN_GUEST_NAME, "test name");
        testValues.put(OrderlistContract.OrderlistEntry.COLUMN_PARTY_SIZE, 99);
        ...
        String emptyQueryError = "Error: No Records returned from orderlist query";
    ...
    void deleteTheDatabase(){
        try {
            ...
            fail("Make sure you have a member called DATABASE_NAME in the OrderlistDbHelper");
        }catch (Exception ex){
            fail(ex.getMessage());
        }
