...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (3) Tạo một biến instance lưu trữ một Cursor và đặt tên là mData
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (5) Tạo và khởi chạy AsyncTask
    }
    ...
    // TODO (1) Tạo AsyncTask với các generic type sau đây <Void, Void, Cursor>
    // TODO (2) Trong phương thức doInBackground, viết code để truy cập DroidTermsExample
    // provider và trả về đối tượng Cursor
    // TODO (4) Trong phương thức onPostExecute, lưu trữ đối tượng Cursor trong mData
